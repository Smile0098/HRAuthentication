		...
		<div class="text-center">
			<form class=" m-5 p-5" action="edit" method="post">
				...
				<div class="text-left form-group row">
					...
					<div class="col-sm-10">
						<input type="text" pattern=".{1,100}" title="Max 100 character" name="name" id="name"
				...
				<div class="text-left form-group row">
					...
					<div class="col-sm-10">
						<input type="email" pattern=".{1,100}" title="Max 100 character" name="email" id="email"
				...
				<div class="text-left form-group row">
					...
					<div class="col-sm-10">
						<input type="text" pattern=".{1,500}" title="Max 500 character" name="location" id="location"
