		...
		<div class="text-center">
			<form id="myForm" class=" m-5 p-5" method="post" action="signup" >
				...
				<div class="text-left form-group row">
					...
					<div class="col-sm-10">
						<input class="form-control" type="text" pattern=".{5,50}" title="Min 5, Max 50 character" name="username"
				...
				<div class="text-left form-group row">
					...
					<div class="col-sm-10">
						<input class="form-control" type="password" pattern=".{5,50}" title="Min 5, Max 50 character" name="password"
